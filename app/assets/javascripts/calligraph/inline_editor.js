var make_page_editable = function(content_data_element, selected_language) {
    ...
    $('img.admin-editable').each(function() {
        ...
        $(self).click(function() {
            ...
            var picoModalHtml = "<div id='" + $(self).data("src") + "'><p>Choose New Image: </p><input type='text' value='" + $(self).attr("src") + "'/></div>" + "<div id='" + $(self).data("alt") + "'><p>Enter Alt Text: </p><input type='text' value='" + $(self).attr("alt") + "'/></div>" + "<div id='" + $(self).data("title") + "'><p>Image title: </p><input type='text' value='" + $(self).attr("title") + "'/></div>" + "<p><a id='change_image'>Change</a></p>";
    ...
    $('area.admin-editable').each(function() {
        ...
        $(self).click(function() {
            ...
            var picoModalHtml = "<div id='" + $(self).data("href") + "'><p>Choose New Link Path: </p><input type='text' value='" + $(self).attr("href") + "'/></div>" + "<div id='" + $(self).data("title") + "'><p>Link title: </p><input type='text' value='" + $(self).attr("title") + "'/></div>" + "<p><a id='change_hyperlink'>Change</a></p>";
    ...
    $('a.admin-editable').each(function() {
        ...
        $(self).click(function() {
            ...
            var picoModalHtml = "<div id='" + $(self).data("href") + "'><p>Choose New Link Path: </p><input type='text' value='" + $(self).attr("href") + "'/></div>" + "<div id='" + $(self).data("text") + "'><p>Link text: </p><input type='text' value='" + $(self).html() + "'/></div>" + "<div id='" + $(self).data("title") + "'><p>Link title: </p><input type='text' value='" + $(self).attr("title") + "'/></div>" + "<p><a id='change_hyperlink'>Change</a></p>";
    ...
    $('.admin-editable.youtube-video').each(function() {
        ...
        $(self).find(".change-youtube-video").click(function() {
            var picoModalHtml = "<div id='" + $(self).data("src") + "'><p>Enter Youtube Video Link: </p><input type='text' value='" + $(self).find('iframe').attr("src") + "'/></div>" + "<p><a id='change_video'>Change</a></p>";
    ...
    $('.admin-editable.bg-image').each(function() {
        ...
        $(self).find(".change-bg-image").click(function(event) {
            ...
            var picoModalHtml = "<div id='" + $(self).data("bg-image") + "'><p>Enter New Background Image Link: </p><input type='text' value='" + decodeBgImageUrl($(self).css('background-image')) + "'/></div>" + "<p><a id='change_bg'>Change</a></p>";
